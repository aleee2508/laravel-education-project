      ...
      <section class="container-grado-medio-inf">
  			<div class="wraper-grado-medio">
  				<h2>{{$infoPage['pagina grado medio informatica titulo']}}</h2>
  				<div class="container-text-grado-medio">
  					<p>{{$infoPage['pagina grado medio informatica texto1']}}</p>
  					<p>{{$infoPage['pagina grado medio informatica texto2']}}</p>
  					<p>{{$infoPage['pagina grado medio informatica texto3']}}</p>
  				</div>
  			</div>
