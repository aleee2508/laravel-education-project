      ...
      <section class="container-grado-medio-inf">
  			<div class="wraper-grado-medio">
  				<h2>{{$infoPage['pagina grado superior sanidad titulo']}}</h2>
  				<div class="container-text-grado-medio">
  					<p>{{$infoPage['pagina grado superior sanidad texto1']}}</p>
  					<p>{{$infoPage['pagina grado superior sanidad texto2']}}</p>
  					<p>{{$infoPage['pagina grado superior sanidad texto3']}}</p>
  				</div>
  			</div>
